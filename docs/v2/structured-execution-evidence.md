...
From `0.4.0-preview.23`, `ProviderPlanNode.Details` may carry what the provider actually
...
`Ordinal` comparison on every provider, MongoDB included (0.4.0-preview.23 and
...
from `buildInfo` (0.4.0-preview.23 and later;
