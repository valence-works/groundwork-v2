...
```xml
<PackageReference Include="Groundwork.Sqlite" Version="0.4.0-preview.6" />
<PackageReference Include="Groundwork.Records.Store" Version="0.4.0-preview.6" />
<PackageReference Include="Groundwork.Extensions.DependencyInjection" Version="0.4.0-preview.6" />
```
...
```xml
<PackageReference Include="Groundwork.PostgreSql" Version="0.4.0-preview.6" />
<PackageReference Include="Groundwork.Records.Store" Version="0.4.0-preview.6" />
<PackageReference Include="Groundwork.Analyzers" Version="0.4.0-preview.6" PrivateAssets="all" />
<PackageReference Include="Groundwork.Schema.Generator" Version="0.4.0-preview.6" PrivateAssets="all" />
```

**A library that declares storage but does not pick a provider:**
```xml
<PackageReference Include="Groundwork.Records" Version="0.4.0-preview.6" />
```
Consumers supply the provider and `Groundwork.Records.Store`. Your library stays provider-neutral.

**Unit tests without a database:**
```xml
<PackageReference Include="Groundwork.Testing" Version="0.4.0-preview.6" />
```
See **[Testing](Testing)**.
