...
- Scalar `Sum` is limited to mapped `Int32`, `Int64`, and `Decimal` columns. Integer sums return
  `Int64`; decimal sums retain `Decimal`; nullable/all-null sums are null. `Min` and `Max` accept
  mapped orderable columns, ignore nulls, and return null when no non-null value exists. The
