...
```bash
gh workflow run publish-nuget.yml --ref v0.4.0-preview.27 \
  -f version=0.4.0-preview.27 -f publish=true -f confirm=0.4.0-preview.27
```
...
dotnet add package Groundwork.Records.Store --version 0.4.0-preview.27
```
...
```bash
dotnet tool install --global Groundwork.Tool --version 0.4.0-preview.27 \
