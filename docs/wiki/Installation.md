...
gh workflow run publish-nuget.yml --ref v0.4.0-preview.23 \
  -f version=0.4.0-preview.23 -f publish=true -f confirm=0.4.0-preview.23
```
...
```bash
dotnet add package Groundwork.Sqlite --version 0.4.0-preview.23
dotnet add package Groundwork.Records.Store --version 0.4.0-preview.23
```
...
```bash
dotnet tool install --global Groundwork.Tool --version 0.4.0-preview.23 \
