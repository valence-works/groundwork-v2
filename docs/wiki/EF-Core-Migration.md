...
```bash
dotnet add package Groundwork.EntityFrameworkCore --version 0.4.0-preview.16
dotnet add package Groundwork.Records.Store --version 0.4.0-preview.16
dotnet add package Groundwork.PostgreSql --version 0.4.0-preview.16
```
