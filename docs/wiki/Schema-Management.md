...
```bash
dotnet tool install --global Groundwork.Tool --version 0.4.0-preview.3 \
...
```xml
<PackageReference Include="Groundwork.SchemaTool.MSBuild" Version="0.4.0-preview.3" PrivateAssets="all" />
