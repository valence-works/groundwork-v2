...
public static class PredicateCanonicalizer
{
    ...
    internal static string ToCanonicalString(Predicate predicate, bool includeValues)
    {
        ...
        return predicate switch
        {
            ...
            Predicate.ElementOf elementOf => "element-of(" + elementOf.Set.Name + "," + elementOf.Quantifier + "," + string.Join(",", elementOf.Values.Select(value => value.ToCanonicalString(includeValues))) + ")",
